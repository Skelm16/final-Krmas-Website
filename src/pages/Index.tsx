...
const Index = () => {
      ...
      const checkAndLoad = () => {
        if ((window as any).tsParticles) {
          (window as any).tsParticles
            .load("particles-hero", particlesConfig)
            .catch((error: any) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <div id="particles-hero" className="absolute inset-0 z-0 pointer-events-none"></div>
        ...
        <div className="section-container relative z-20 text-center">
          ...
          <p className="text-lg md:text-xl mb-10 max-w-3xl mx-auto text-muted-foreground">
            From voice assistants to chatbots, we help businesses scale faster,
            smarter, and 24/7.
          </p>
        ...
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Practical automations that save time, capture leads, and boost
              revenue.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-3">
                AI Voice Assistant (Phone Calls)
              </h3>
              <p className="text-muted-foreground mb-4">
                Automate customer calls with lifelike AI agents that sound
                human, answer FAQs, collect leads, and set appointments.
              </p>
            ...
            <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Smart bots that reply instantly, handle customer queries, send
                updates, and increase conversions.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-primary">•</span>
            ...
            <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                AI-powered chatbots that engage followers, boost sales, and
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                A 24/7 intelligent assistant on your site that answers
                questions, captures leads, and improves customer experience.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-primary">•</span>
            ...
            <Card className="p-8 bg-card border-border hover:border-primary/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">
                Need something unique? We build tailored AI solutions for your
                business workflow.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
      ...
      <section className="section-padding bg-secondary/20">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Work directly with Krish for fast, personal delivery using
              cutting-edge tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="p-8 bg-card border-border">
              <p className="text-lg mb-6 italic">
                "Their team shipped a compliant, production-grade LLM workflow
                in weeks. The assessment rigor and UX polish stood out."
              </p>
            ...
            <Card className="p-8 bg-card border-border">
              <p className="text-lg mb-6 italic">
                "A rare blend of research depth and engineering execution. They
                helped us reduce inference costs by 42% while improving
                quality."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">
        ...
        <div className="section-container">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <p className="text-lg mb-6">
              <strong>Hi, I'm Krish.</strong> I started KRMAS to help businesses
              harness the power of AI without the complexity. With years of
              experience in automation and AI development, I've seen firsthand
              how the right solutions can transform operations, boost
              efficiency, and drive growth.
            </p>
            <p className="text-lg text-muted-foreground">
              <strong>Our Story & Mission:</strong> KRMAS was born from a simple
              belief: AI should be accessible, practical, and deliver real
              results. We're not about flashy tech for the sake of it. We focus
              on building tools that solve real problems—whether it's saving
              your team hours each week, capturing more leads, or improving
              customer satisfaction. Our mission is to make AI work for you,
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-primary mb-4">
                    Founder, Owner & AI Automation Specialist
                  </p>
                  <p className="text-muted-foreground">
                    Passionate about leveraging AI to solve real business
                    challenges. With a background in software engineering and
                    machine learning, Krish brings both technical expertise and
                    a deep understanding of business needs to every project.
                    When not building AI solutions, you'll find him exploring
                    the latest developments in the AI space or consulting with
                    businesses on their automation journey.
                  </p>
                </div>
              </div>
            </Card>
        ...
        <div className="section-container">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                AI Automation Agency helping businesses scale with intelligent
                solutions.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} KRMAS AI Agency. All rights
              reserved.
            </p>
          </div>
        </div>
